...
class AuthorListViewTest(TestCase):
    ...
    def test_pagination_is_ten(self):                           # Passes only if AuthorListView sets paginate_by to 10
        resp = self.client.get(reverse('authors'))
        self.assertEqual(resp.status_code, 200)
    ...
    def test_lists_all_authors(self):
        ...
        # (passes only if AuthorListView sets paginate_by to 10)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_renewal_date_initially_has_date_three_weeks_in_future(self):
        ...
        # Note the way to access the value of the initial value of the form field (renewal_date)
...
# Check this out for the test code related to the challenge:
